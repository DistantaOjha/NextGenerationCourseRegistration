...
.loginButton {
  background-color: rgb(204, 125, 7);
  color: white;
  padding: 12px 20px;
  margin: 8px 8px;
  width: 57%;
...
<form action="studentPages/studentLand.php" method="post" class = "loginForm">
    <div>
        ...
        <input type="text" class= "loginInputText" placeholder="Enter your username" name="ulogin" required>
        </br>
        <label for="pass" class = "loginLabel"><b>Password</b></label>
        </br>
        <input type="password" class= "loginInputPass" placeholder="Enter Password" name="pass" required> 
        </br>      
